...
import {createProduct, fetchSubtypes, fetchProducts, fetchTypes} from "../../http/productAPI";
        ...
        >
            ...
            <Modal.Body>
                <Form>
                    ...
                    <Dropdown className="mt-2 mb-2">
                        <Dropdown.Toggle>{product.selectedSubtype.name || "Выберите тип"}</Dropdown.Toggle>
                        <Dropdown.Menu>
